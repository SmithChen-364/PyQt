...
class QMessageBoxDemo(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("QMessageBoxDemo Demo")
        self.resize(300,400)
    ...
    def showDialog(self):
        ...
        if text =="显示关于对话框":
            ...
            QMessageBox.warning(self, "警告", "这是一个警告",QMessageBox.Yes|QMessageBox.No,QMessageBox.Yes)
        elif text =="显示错误对话框":
            QMessageBox.critical(self, "错误", "这是一个错误",QMessageBox.Yes|QMessageBox.No,QMessageBox.Yes)
        elif text =="显示提问对话框":
            QMessageBox.question(self, "提问", "这是一个提问",QMessageBox.Yes|QMessageBox.No,QMessageBox.Yes)
